...
Resource        ../Repository/Web/IOT_RECL_CBS_ReCL_repository.robot
...
Request post orderReconnect
    [Arguments]     ${token}
    ${url}=     set variable        https://phxdev-nginx1.intra.ais:2443/conductor/v1/order/reconnect
